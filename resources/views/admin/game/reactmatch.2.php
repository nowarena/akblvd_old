    ...
    var Boxes = React.createClass({
        render: function() {
            var boxNodes = this.props.data.map(function(box) {
                var boundClick = this.handleClick.bind(this, i);
                return (
                    <Box onClick={boundClick} displayJ={box.displayJ} j={box.j} i={box.i} key={box.indexKey} index={box.index}>
                    </Box>
                );
            });
            return (
        ...
        render: function() {
            return (
                <div className="Game">
                    ...
                    <Container data={this.props.data} clickFunc={this.handleClick.bind(this)}/>
